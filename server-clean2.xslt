...
<xsl:stylesheet version="2.0"
  ...
  xmlns:my="my:my">
    ...
    <xsl:template match="ThingSaveData[key('top-level-junk2', ReferenceId) or key('child-of-top-level-junk2', ReferenceId) or key('nearby-ore', ReferenceId) or key('far-away', ReferenceId)]">
        <!-- <xsl:copy>
            <xsl:apply-templates select="@*|node()"/>
        </xsl:copy> -->
    </xsl:template>
